...
In this work, the high order solution uses the spatial discretization presented in Section \ref{sec:fic_fem} and the backward differentiation formula for the time integration from Section \ref{sec:time_integration_bdf}.
