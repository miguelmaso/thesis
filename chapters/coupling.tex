...
%In this section, we present three different cases to validate the proposed coupling strategy and to show its potential for practical applications. The first example considers the propagation of a water wave in a 307 m-long laboratory channel. The problem is unidirectional and the wave is generated by a piston and not by a landslide impact. The simplicity of this test and the availability of experimental, numerical and analytical reference solutions, allow us to focus on specific aspects of the coupling strategy and to verify more clearly its overall accuracy, robustness and scope. The test is analyzed both in two and three dimensions.
%The second example is devoted to validating the methodology for a representative LGW case. The aim of this test is to reproduce the water wave generated in a laboratory flume by the impact of another water mass. In the last test, we consider a realistic configuration of an alpine lake and we simulate a hypothetical LGW scenario. Our numerical solution is compared to another LGW solver presented in the literature.
...
\begin{table} [htb]
    ...
    \begin{minipage}[b]{.48\textwidth}
    \centering
    % \includegraphics[width=.9\textwidth]{img/piston_stroke.pdf} \vspace*{-10pt}
    \captionof{figure}{Solitary wave example. Paddle position according to time. Data provided in Krautwald et al. \cite{krautwald2020,krautwald2021,krautwald2022}.}
    \label{piston_stroke}
    \end{minipage}
\end{table}
...
\begin{figure} [htb]
    \centering
    % \includegraphics[width=\textwidth]{img/solitary_wave.pdf}
...
\begin{figure} [htb]
    \centering
    % \includegraphics[width=\textwidth]{img/solitary_wave_propagation.pdf}
...
\begin{figure} [htb]
    \centering
    % \includegraphics[width=\textwidth]{img/solitary_wave_time_convergence.pdf}
...
\begin{figure} [htb]
    \centering
    % \includegraphics[width=\textwidth]{img/landslide_wave_channel.pdf}
...
\begin{figure}[p]
    ...
    \begin{subfigure}[c]{\columnwidth}
        ...
        \centering
        % \includegraphics[width=\columnwidth]{img/t07.png}
        \label{t07pfemTest2}
    \end{subfigure}
    ...
    \begin{subfigure}[c]{\columnwidth}
        ...
        \centering
        % \includegraphics[width=\columnwidth]{img/t15.png}
        \label{t15pfemTest2}
    \end{subfigure}
    ...
    \begin{subfigure}[c]{\columnwidth}
        ...
        % \includegraphics[width=\columnwidth]{img/t28.png}
        \label{t28pfemTest2}
    \end{subfigure}
    ...
    \begin{subfigure}[c]{\columnwidth}
        ...
        \begin{minipage}[c]{0.4\textwidth}
            % \includegraphics[width=\textwidth]{img/t15zoom.png}
        \end{minipage}
    \end{subfigure}
...
\begin{figure} [htb]
    \centering
    % \includegraphics[width=\textwidth]{img/landslide_wave_propagation.pdf}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.6\textwidth}
        % \includegraphics[width=\textwidth]{img/ex3_lateralview.pdf}
        \caption{Side view.}
    ...
    \begin{subfigure}{0.75\textwidth}
        % \includegraphics[width=\textwidth]{img/ex3_topview.pdf}
        \caption{Top view.}
        \label{ex3_topview}
    \end{subfigure}
...
\begin{figure} [p]
    ...
    \begin{subfigure}{\textwidth}
        ...
        % \includegraphics[width=.85\textwidth]{img/ex3_t0.png}
    \end{subfigure}
    \vspace{5pt}
    ...
    \begin{subfigure}{\textwidth}
        ...
        % \includegraphics[width=.85\textwidth]{img/ex3_t5.png}
    \end{subfigure}
    \vspace{5pt}
    ...
    \begin{subfigure}{\textwidth}
        ...
        % \includegraphics[width=.85\textwidth]{img/ex3_t10.png}
    \end{subfigure}
    \vspace{5pt}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \hfill
        % \includegraphics[width=.9\textwidth]{img/ex3_t50.png}
    \end{subfigure}
...
\begin{figure} [ht]
    \centering
    % \includegraphics[width=\textwidth]{img/ex3_max_wave_height.pdf}
